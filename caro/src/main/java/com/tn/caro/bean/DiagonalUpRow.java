...
public class DiagonalUpRow extends Row {
	
	public DiagonalUpRow(Cell cellBegin, Cell cellEnd) {
		super(Row.ROW_TYPE_DIAGONAL_UP, (byte)(cellBegin.getX()-cellEnd.getX() + 1), cellBegin, cellEnd);
